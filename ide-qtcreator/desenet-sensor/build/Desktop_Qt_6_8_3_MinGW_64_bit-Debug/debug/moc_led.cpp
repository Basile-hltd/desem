...
static constexpr auto qt_meta_stringdata_ZN3LedE = QtMocHelpers::stringData(
    "Led"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3LedE[] = {
...
Q_CONSTINIT const QMetaObject Led::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3LedE.offsetsAndSizes,
    qt_meta_data_ZN3LedE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3LedE_t,
        // Q_OBJECT / Q_GADGET
...
void *Led::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3LedE.stringdata0))
