...
public:
	...
	AcceleratedDrawingMethods acceleratedDrawingMethods() const override;
	bool initialize() override;
	bool enable() override;
	bool disable() override;
	PixelColor pixel(const Point & point) override;
	void setPixel(const Point & point, PixelColor color) override;
	void clear(PixelColor background = White) override;
	void drawLine(const Point & begin, const Point & end, PixelColor color) override;
	void drawText(const Point & topLeft, const std::string & text, PixelColor color) override;
