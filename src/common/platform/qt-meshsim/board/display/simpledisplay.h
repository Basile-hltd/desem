...
public:
    ...
    static const uint8_t X_MAX = 150 - 1;		///< Display's maximum x value
    static const uint8_t Y_MAX = 150 - 1;		///< Display's maximum y value
    static const uint8_t ROW_MAX = 150 - 1;		///< Display's maximum row value
