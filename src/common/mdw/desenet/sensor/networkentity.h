...
public:
    ...
    virtual void onTimeSlotSignal(const ITimeSlotManager & timeSlotManager, const ITimeSlotManager::SIG & signal) override;
...
protected:
    ...
    /**
     * @brief Called by Abstract Application
     */
    void svSyncRequest(AbstractApplication* pAbstractApplication);

    /**
     * @brief Called by Abstract Application
     */
    void svPublishRequest(AbstractApplication* pAbstractApplication, SvGroup group);
